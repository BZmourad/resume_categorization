...
st.title("Application of Resume Categorization")
st.subheader("Developed with Python & Machine Learning")

uploaded_files = st.file_uploader("Upload CV (PDF files)", type="pdf", accept_multiple_files=True)
output_directory = st.text_input("Output Result Directory", "output_resumes")
